...
description = "application definition and configuration file locations"
toc = true
weight = 110
+++
...
The [XDG Base specification](https://github.com/adrg/xdg#xdg-base-directory) is supported, including standard environment variable based overrides like using `XDG_CONFIG_HOME`, for storing these in the home directory with system wide fallback locations.
